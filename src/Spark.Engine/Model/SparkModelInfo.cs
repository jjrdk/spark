        ...
        public static List<SearchParamDefinition> SparkSearchParameters = ModelInfo.SearchParameters.Union(
                new List<SearchParamDefinition>()
                {
                    new SearchParamDefinition()
                    {
                        ...
                        Name = "custodian",
                        Description =
                            new Markdown(@"custom search parameter on Composition for generating $document"),
                        Type = SearchParamType.Reference,
                        Path = new string[] {"Composition.custodian"},
                    ...
                    new SearchParamDefinition()
                    {
                        ...
                        Description =
                            new Markdown(@"custom search parameter on Composition for generating $document"),
                        Type = SearchParamType.Reference,
                        Path = new string[] {"Composition.event.detail"},
                    ...
                    new SearchParamDefinition()
                    {
                        ...
                        Description = new Markdown(@"Organization that provides the Encounter services."),
                        Type = SearchParamType.Reference,
                    ...
                    new SearchParamDefinition()
                    {
                        Resource = "Slot",
                        Name = "provider",
                        Description = new Markdown(@"Search Slot by provider extension"),
                        Type = SearchParamType.Reference,
                        Path = new string[]
                        {
                            @"Slot.extension[url=http://fhir.blackpear.com/era/Slot/provider].valueReference"
                        },
                        Target = new ResourceType[] {ResourceType.Organization}
                    }
                })
