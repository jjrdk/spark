...
//        {
//            var includebody = request.PreferRepresentation();
...
//        {
//            var message = request.CreateBareFhirResponse(fhir);
...
//        {
//            var contentType = request.GetContentTypeHeaderValue();
//            TransferResourceIdIfRawBinary(contentType, resource, id);
//        }
...
//        {
//            var accept = request.GetAcceptHeaderValue();
//            return ContentType.XML_CONTENT_HEADERS.Contains(accept)
//                || ContentType.JSON_CONTENT_HEADERS.Contains(accept);
//        }
